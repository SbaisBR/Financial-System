...
begin
  //Quando clicar no Movimentos pelo Menu, clique o botão movimentos
  BtnMovimento.Click;
end;

procedure TFrmMenu.SairClick(Sender: TObject);
begin
  //Quando clicar no sair pelo Menu, clique no botão SAIR
  BtnSair.Click;
end;
...
begin
  //Quando clicar no usuarios pelo Menu, clique o botão Usuarios.
